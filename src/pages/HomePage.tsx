  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="section" aria-labelledby="web-dev-team-heading">
          <div className="container">
            <div className="text-center mb-16">
              <h2 id="web-dev-team-heading" className="mb-4">Web Development Team</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Meet our dedicated web development team lead
              </p>
            </div>
            ...
            <div className="flex justify-center">
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold mb-1">Vivek Deshmukh</h3>
                  <p className="text-blue-600 font-medium mb-4">Head of Development Team</p>
                  <p className="text-gray-600 mb-6">Leading our web development initiatives and creating engaging content for students.</p>
                  ...
                  <p className="mt-4 text-sm text-gray-500">Contact: 9156569060</p>
                </div>
              </motion.div>
            </div>
          </div>
